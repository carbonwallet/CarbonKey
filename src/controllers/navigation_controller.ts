...
export default class extends Controller {
  ...
  resetUI() {
    ...
    if(this.restoreTarget.getAttribute('data-controller') != null) {
      this.restoreTarget.removeAttribute('data-controller')
    }
  }
  ...
  scanner() {
    this.resetUI()
    this.scannerTarget.setAttribute('data-controller', 'scanner')
